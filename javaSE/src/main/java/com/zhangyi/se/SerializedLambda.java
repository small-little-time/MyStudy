 ...
 * 功能描述:
 * 函数式接口,获取字段名
 * 使用方式: SerializedLambda.getColumnName(ScmBatchIn::getBillType)
 *
 * @author houMedia
 * @date 2020/03/30
 */
...
public class SerializedLambda implements Serializable {
     ...
     * @return
     */
    public static <T> String getColumnName(MyFunction<T, ?> column) {
     ...
     */
    public static SerializedLambda resolve(MyFunction lambda) {
     ...
     * @return 返回解析后的结果
     */
    public static <T> SerializedLambda resolveFunc(MyFunction<T, ?> func) {
